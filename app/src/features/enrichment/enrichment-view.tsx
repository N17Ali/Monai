...
import { editableKindOf, enrichmentUpdateSchema, kindLabels, type EnrichmentUpdateInput, type Transaction } from "@shared/contracts/transaction";
...
function draftDefaults(draft: Transaction): EnrichmentUpdateInput {
  return { kind: editableKindOf(draft.kind), amountToman: rialToToman(draft.amountRial), note: draft.userNote ?? "", occurredAt: draft.occurredAt };
}
