...
import { editableKindOf, editableTransactionKinds, enrichmentUpdateSchema, kindLabels, type EnrichmentUpdateInput, type Transaction } from "@shared/contracts/transaction";
